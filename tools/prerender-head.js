...
function buildHead(meta) {
  ...
  const tags = [
    ...
    `<link rel="alternate" hreflang="tr-TR" href="${escapeHtml(canonicalUrl)}" />`,
    ...
    `<meta name="keywords" content="${escapeHtml(siteMeta.seoKeywords)}" />`,
    `<meta name="robots" content="${meta.noIndex ? "noindex, nofollow" : "index, follow"}" />`,
    `<meta name="language" content="Turkish" />`,
    `<meta http-equiv="content-language" content="${escapeHtml(siteMeta.language)}" />`,
    `<meta name="geo.region" content="${escapeHtml(siteMeta.geoRegion)}" />`,
    `<meta name="geo.placename" content="${escapeHtml(siteMeta.geoPlacename)}" />`,
    `<meta name="geo.position" content="${escapeHtml(siteMeta.geoPosition)}" />`,
    `<meta name="ICBM" content="${escapeHtml(siteMeta.geoPosition.replace(";", ", "))}" />`,
